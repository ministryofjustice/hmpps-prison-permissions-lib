...
export const corePersonRecordPermissionPaths: Record<CorePersonRecordPermission, Path<PrisonerPermissions>> = {
  ...
  [CorePersonRecordPermission.read_emergency_contacts]: `${basePath}.${CorePersonRecordPermission.read_emergency_contacts}`,
  [CorePersonRecordPermission.edit_emergency_contacts]: `${basePath}.${CorePersonRecordPermission.edit_emergency_contacts}`,
}
